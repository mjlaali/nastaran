...
$(document).ready(function () {
  ...
  var pager = {
    ...
    reset: function () {
      ...
      TweenLite.to($gotop1, 0.4, {
        right: "100%", zIndex: 0, onComplete: function () {
    ...
    forward: function (gotop2, /* optional */ gotop3) {
      ...
      (new TimelineLite())
        .set(gotop2, { right: "100%", zIndex: self.topz })
        .set(gotop3, { zIndex: maxz + 1 })
        .to(gotop2, 0.4, { right: "15%" })
        .to(gotop3, 0.3, { right: 0, onComplete: function () { gotop3.removeClass('currentpage'); } }, "-=0.2");
    },
